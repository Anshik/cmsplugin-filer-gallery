##########################
Contributing to cmsplugin-filer-gallery
##########################

Like every open-source project, cmsplugin-filer-gallery is always looking for motivated
...
#. cmsplugin-filer-gallery is hosted on `GitHub`_, at `fork`_
...
Since we're hosted on GitHub, cmsplugin-filer-gallery uses `git`_ as a version control system.
...
<http://www.transifex.net/projects/p/cmsplugin-filer-gallery/>`_ where you can translate
...
.. _fork: http://github.com/fivethreeo/cmsplugin-filer-gallery.git
