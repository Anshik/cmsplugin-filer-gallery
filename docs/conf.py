...
extensions = ['cmsplugin_filer_gallery', 'sphinx.ext.intersphinx']
intersphinx_mapping = {
...
htmlhelp_basename = 'cmsplugin_filer_gallerydoc'
...
latex_documents = [
  ('index', 'cmsplugin_filer_gallery.tex', u'cmsplugin-filer-gallery Documentation',
