...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilerGallery.animation'
        db.add_column('cmsplugin_filergallery', 'animation', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FilerGallery.animation'
        db.delete_column('cmsplugin_filergallery', 'animation')
